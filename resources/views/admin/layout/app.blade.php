...
<head>
    <meta charset="UTF-8">
    <title>Admin - Bali Sari Tour</title>
        ...
        <div class="sidebar">
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('admin.pelanggan.view') }}" class="nav-link {{ (request()->segment(2) == 'pelanggan') ? 'active' : '' }}">
                            <i class="nav-icon fas fa-users"></i>
                            <p>Pelanggan</p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ route('admin.sopir.view') }}" class="nav-link {{ (request()->segment(2) == 'sopir') ? 'active' : '' }}">
                            <i class="nav-icon fas fa-car"></i>
                            <p>Sopir</p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ route('admin.jadwal.view') }}" class="nav-link {{ (request()->segment(2) == 'jadwal') ? 'active' : '' }}">
                            <i class="nav-icon fas fa-calendar"></i>
                            <p>Jadwal</p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ route('admin.invoice.view') }}" class="nav-link {{ (request()->segment(2) == 'invoice') ? 'active' : '' }}">
